...
<body>
	<header id="home" class="header">
		<nav class="nav" role="navigation">
			<div class="container nav-elements">
				...
				<!-- branding -->
				<ul class="navbar">
					<li><a href="/hplusapp/">home</a></li>
	                <li><a href="/hplusapp/goToSearch">search</a></li>
	                <li><a href="/hplusapp/redirectToLinkedIn">linkedin</a></li>
				</ul>
				<!-- navbar -->
			</div>
	...
	<!-- #home -->
	<span cssClass="success">${dataSaved}</span>
	
   	<section id="login" class="section">
		<div class="container tagline">
			<em>LOGIN USER</em>
			<form:form action="/hplusapp/login" method="post" modelAttribute="login">
			 ...
			 <a class="card-title" href="/hplusapp/goToRegistration">Register new user? Click here</a>
		</div>
	</section>
	<!-- #products -->
